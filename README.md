...
>현재 가지고 있는 **Meta Quest2**를 사용해 **Oculus Integration**을 활용한 게임을 만들것이다.<br>
...
| 5|무기|<img src="./img/Att.png" width="250" height="150">|
...
\- 플레이어(그래픽)
>7. ~~게임화면에서 왼쪽 팔에 플레이어의 체력 게이지, 메인코어 체력 게이지, 플레이어의 포인트 텍스트가 있다.~~
>8. 캐릭터는 헬멧을 쓴 사람으로 한다. - 사양문제 -
...
>13. ~~B버튼을 누르면 메뉴창이 나온다.~~(변경)

\- 게임(그래픽)
>14. ~~메인코어 옆면엔 조작이 가능한 모니터가 있고, 모니터에는 상점이 있다.~~(변경)
>15. ~~맵은 평지와 미로형태의 맵이 있고 중앙에는 메인코어(빛나는 수정이 떠있는 모양)가 있다.~~(변경)
...
>29. ~~탱커봇은 플레이어보다 2배크며 망치가 손에 장착되 있는 로봇이다.~~(변경)
...
>43. ~~무기는 근접형, 권총형, 돌격소총형, 미니건이 있다.~~(변경)
>44. ~~도구는 EMP수류탄, 힐킷, 설치형 방패막, 지뢰가 있다.~~(변경)
...
동영상 : <br>
<iframe width="560" height="315" src="https://www.youtube.com/embed/b92uHv5JzBM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
>5. 미니건형은 한발당 40데미지와 한번에 100발, 총 200발을 쏠 수 있다.(80%)
>6. 총기류는 총기 옆에 홀로그램 형식 텍스트로 남은 탄창이 적혀있다.(100%)
>7. 각 버튼을 누르면 해당 아이템을 구매할 수 있다.(0%)
>8. B버튼을 누르면 메뉴창이 나온다.(75%)
>9. EMP 수류탄의 안전핀을 뽑고 트리거를 누르면 5초의 타이머가 시작된다.(0%)
>10. EMP 수류탄이 5초가 지난후 터지면 주변 로봇들은 다 비활성화(기절상태)가 된다.(0%)
>11. 힐킷을 들고 몸에 바늘쪽을 찌르고 트리거를 누르면 25의 체력이 회복된다.(0%)

(그래픽)

>12. 근첩형은 야구배트처럼 생겼다.(0%)
>13. 권총형은 미래형이다.(100%)
>14. 돌격소총형은 Vector형태로 미래형이다.(100%)
>15. 미니건형은 미니건형태의 레이저총이다.(85%)
>16. EMP 수류탄은 수류탄 모양에 안전핀, 트리거가 있다.(0%)
>17. 힐킷은 주사기형태에 초록 액체가 담겨있다.(0%)
>18. 메인코어 옆면엔 조작이 가능한 모니터가 있고, 모니터에는 상점과 업그레이드 버튼이 있다.(0%)
